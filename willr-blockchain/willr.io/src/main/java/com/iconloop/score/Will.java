...
package com.iconloop.score.will;
import com.iconloop.score.digitalasset.DigitalAsset;
...
public class Will {
    ...
    private HashMap inherits = new HashMap();
    ...
    public void setInherit(Address inherit, String name, String value) {
        ...
        inherits.put(inherit,digitalAsset);
    }

    @External(readonly=true)
    public Object getInherit(Address inherit) {
